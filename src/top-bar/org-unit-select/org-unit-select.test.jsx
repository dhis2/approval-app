...
describe('<OrgUnitSelect>', () => {
    it('renders an OrganisationUnitTree in a ContextSelect if a workflow, a period and a category option combo have been set', () => {
    ...
    it('is disabled if workflow, period and category option combo is not set', () => {
        useSelectionContext.mockImplementation(() => ({
            workflow: {},
            period: {},
            orgUnit: {},
    ...
    it('is disabled if period and category option combo are not set', () => {
        useSelectionContext.mockImplementation(() => ({
            workflow: mockWorkflows[0],
            period: {},
            orgUnit: {},
    ...
    it('is disabled if category option combo are not set', () => {
        useSelectionContext.mockImplementation(() => ({
            workflow: mockWorkflows[0],
            period: { id: '20120402' },
            orgUnit: {},
    ...
    it('displays the correct tooltip text when period has not been set yet', () => {
        ...
        expect(contextSelect.props().requiredValuesMessage).toBe('Choose a period and a category option combo first')
    })
})
